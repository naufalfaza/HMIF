...
<div class="content-wrapper">
  <div class="container">
    ...
    <section class="contact-us" id="aspirasi">
      <div class="contact-us-bgimage grid-margin" >
        <div class="pb-4">
          <h4 class="px-3 px-md-0 m-0" data-aos="fade-down">Apakah Anda Memiliki Aspirasi ?</h4><br>
          <h4 class="pt-1" data-aos="fade-down">Ayo Ajukan Aspirasi Anda !!</h4>
        </div>
        <div data-aos="fade-up">
          <button class="btn btn-rounded btn-outline-danger" data-toggle="modal" data-target="#exampleModal">Kotak Aspirasi</button>
        </div>          
      </div>
    </section>
      ...
      <div class="row text-center text-md-left">
        ...
        <div class="col-12 col-md-6 col-lg-4 grid-margin">
            ...
            <div class="d-flex justify-content-center justify-content-md-start">
              <a href="https://www.instagram.com/hmif_unnur/" target="_blank"><span class="mdi mdi-instagram"></span></a>
            </div>
        </div>
      </div>  
    </section>
    <footer class="border-top">
      <p class="text-center text-muted pt-4">Copyright © <?=date('Y') ?><a href="" class="px-1">HMIF UNIVERSITAS NURTANIO BANDUNG</a>All rights reserved.</p>
    </footer>
